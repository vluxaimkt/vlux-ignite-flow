import {
  TrendingUp, Package, AlertTriangle, Zap, ArrowUpRight,
...
export function DashboardMockup() {
  return (
    <div className="relative">
      {/* glow */}
      <div className="absolute -inset-4 bg-gradient-to-tr from-[color:var(--cyan-glow)]/20 via-transparent to-[color:var(--mint)]/15 blur-3xl rounded-[2rem] -z-10" />

      <div className="surface-card overflow-hidden">
        {/* window chrome */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-[color:var(--hairline)] bg-[color:var(--surface)]/60">
          ...
          <div className="flex items-center gap-1.5 text-xs text-[color:var(--positive)]">
        ...
        <div className="grid grid-cols-12 gap-3 p-4">
          ...
          {[
            ...
            <div
              key={k.label}
              className="col-span-4 rounded-lg bg-[color:var(--surface-2)]/70 border border-[color:var(--hairline)] p-3"
            >
              <div className="flex items-center justify-between text-[color:var(--muted-foreground)] text-[10px] uppercase tracking-wider">
                {k.label}
          ...
          {/* Chart */}
          <div className="col-span-12 md:col-span-7 rounded-lg bg-[color:var(--surface-2)]/70 border border-[color:var(--hairline)] p-3">
            <div className="flex items-center justify-between mb-2">
              <div className="text-xs font-medium">Ventas · últimos 14 días</div>
              <div className="text-[10px] text-[color:var(--muted-foreground)] font-mono">+22% MoM</div>
            </div>
            <SparkChart />
          </div>

          {/* Orders by status */}
          <div className="col-span-12 md:col-span-5 rounded-lg bg-[color:var(--surface-2)]/70 border border-[color:var(--hairline)] p-3">
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={r.label}>
                  <div className="flex justify-between text-[10px] text-[color:var(--muted-foreground)] mb-1">
                    <span>{r.label}</span>
                  ...
                  <div className="h-1.5 rounded-full bg-[color:var(--surface-3)] overflow-hidden">
                    <div
                      ...
                      style={{ width: `${r.val}%`, background: `linear-gradient(90deg, ${r.color}, color-mix(in oklch, ${r.color} 60%, transparent))` }}
                    />
                  </div>
                </div>
              ))}
          ...
          <div className="col-span-12 md:col-span-7 rounded-lg bg-[color:var(--surface-2)]/70 border border-[color:var(--hairline)] p-3">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[10px] font-mono text-[color:var(--muted-foreground)]">hoy · 184</span>
            </div>
            <ul className="space-y-1.5 text-[11px]">
              {[
                ...
                <li key={i} className="flex items-center gap-2 text-[color:var(--muted-foreground)]">
          ...
          {/* Alerts */}
          <div className="col-span-12 md:col-span-5 rounded-lg bg-gradient-to-br from-[color:var(--warn)]/10 to-transparent border border-[color:var(--warn)]/30 p-3">
            ...
            <div className="space-y-2 text-[11px]">
              ...
              <div className="text-[color:var(--muted-foreground)]">Predicción IA: cuello de botella en empaque</div>
      ...
      {/* floating IA card */}
      <div className="hidden md:flex absolute -bottom-6 -left-6 surface-card glow-cyan-sm px-3 py-2.5 items-center gap-2.5 float">
        <span className="w-8 h-8 rounded-md bg-gradient-to-br from-[color:var(--cyan-glow)] to-[color:var(--mint)] flex items-center justify-center">
          <Bot className="w-4 h-4 text-[color:var(--primary-foreground)]" />
        </span>
        <div>
          <div className="text-[10px] text-[color:var(--muted-foreground)] uppercase tracking-wider">VLUX IA</div>
