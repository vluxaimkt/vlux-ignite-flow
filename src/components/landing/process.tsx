...
const steps = [
  { icon: Search, title: "Diagnóstico", desc: "Entendemos tu operación real, no la del organigrama." },
  { icon: Map, title: "Mapeo", desc: "Documentamos procesos, datos, herramientas y dolores." },
  { icon: Layers, title: "Prototipo", desc: "Construimos una versión funcional para validar contigo." },
  { icon: Rocket, title: "Implementación", desc: "Lanzamos en producción con datos reales y por etapas." },
  { icon: GraduationCap, title: "Capacitación", desc: "Tu equipo lo adopta porque fue diseñado para ellos." },
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <div className="max-w-2xl reveal">
          ...
          <h2 className="mt-4 text-3xl md:text-5xl font-display font-bold leading-tight">
            De caos operativo a sistema, en{" "}
            <span className="text-gradient-cyan">6 pasos.</span>
          </h2>
        </div>
              ...
              <div key={s.title} className="reveal" style={{ transitionDelay: `${i * 60}ms` }}>
                <div className="flex md:flex-col md:items-start gap-4 md:gap-3">
                  <div className="relative shrink-0">
                    <div className="w-16 h-16 rounded-2xl surface-card glow-cyan-sm flex items-center justify-center">
                  ...
                  <div className="md:mt-3">
                    ...
                    <p className="text-xs text-[color:var(--muted-foreground)] mt-1 leading-relaxed">{s.desc}</p>
                  </div>
                </div>
              </div>
            ))}
